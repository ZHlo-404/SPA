...
from models.dfsp.dfsp_ov import DFSP
from dataset import CompositionDataset
import evaluator as evaluator_ge
from tqdm import tqdm
import matplotlib.pyplot as plt
import seaborn as sns
from models.dfsp.loss import loss_calu
...
def validate_ge(epoch, model, testloader, evaluator, device, phase='val'):
    ...
    results = evaluator.score_model(all_pred_dict, all_obj_gt, bias=1e3, topk=3)    #all_pred_dict [1962, 17029] dict_keys(['open', 'unbiased_open', 'closed', 'unbiased_closed', 'object_oracle', 'object_oracle_unbiased', 'scores'])
